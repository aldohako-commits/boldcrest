...
export default function Header() {
  ...
  return (
    <>
      <header
        className="fixed top-0 left-0 right-0 z-[1000] flex justify-center transition-all duration-[0.8s]"
        style={{
          padding: scrolled ? '0.6rem 3rem' : '1.5rem var(--gutter)',
      ...
      >
        <div
          ...
          style={{
            maxWidth: scrolled ? '56rem' : 'none',
            height: scrolled ? '3.5rem' : 'auto',
            padding: scrolled ? '0 1.5rem' : '0.75rem 1rem',
            borderRadius: scrolled ? '1.75rem' : '0',
        ...
        >
          ...
          <Link href="/" className="z-10 flex items-center">
            <svg
              ...
              className="transition-[width,height] duration-[0.6s]"
              style={{
          ...
          >
            <span
              className="absolute inset-0 flex items-center justify-center text-[1rem] leading-none font-light text-white/80 transition-all duration-[0.5s] group-hover:text-white"
              style={{
