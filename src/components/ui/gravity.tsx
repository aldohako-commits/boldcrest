  ...
  (
    ...
    const registerElement = useCallback(
      (id: string, element: HTMLElement, props: MatterBodyProps) => {
        ...
        // Strip null chamfer from spread options to satisfy Matter.js types
        const { chamfer, ...safeOptions } = (props.matterBodyOptions ?? {}) as Matter.IBodyDefinition & { chamfer?: unknown }
        const bodyOpts = {
          ...safeOptions,
